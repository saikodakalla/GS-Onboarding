...
def create_command(payload: CommandRequest, db: Session = Depends(get_db)) -> CommandSingleResponse:
    """
...
def delete_command(id: int, db: Session = Depends(get_db)) -> CommandListResponse:
    """
